function [stimulus, trace] = read_Intan_RHD2000_stimulus(file, path, size)
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pre_stim = transpose(board_adc_data);
pre_trace = transpose(amplifier_data);

stimulus = pre_stim; 
trace = pre_trace;

clearvars -except stimulus trace 
